...
contract Mummy3D {
    ...
    modifier pyramidConstruct(bool buyLimits) {
        ...
        if (onlyAmbassadors && msg.sender == _MummyAccount) {
            ...
            require(
                    ambassadorsEthLedger_[_MummyAccount] == 2 ether &&
                    ambassadorsEthLedger_[msg.sender] < 2 ether &&
                    SafeMath.add(ambassadorsEthLedger_[msg.sender], msg.value) <= 2 ether
                    );
        } else {
            ...
            if (buyLimits) require(msg.value <= limits());
        }
    ...
    */
    ...
    {
        // King Tut's address
        _MummyAccount = 0x41098637a14185F8DF07CDd51fD9253b597880c2;     // M mummy
        
        // add the ambassadors here. 
        ambassadors_[0xF56Ec0FF7a92ED96D78870f22aaFCa4F3Bf8952e] = true;    // M ambass
        ambassadors_[0xa92F3598097d76E0a8bdda109C8B46d34ECEba91] = true;    // Gus Chrome
        ambassadors_[0x5c0F1060d2AB9f08F1582A68CA248eEeB8DbB725] = true;    // Gus Brave
    }
    ...
    function checkState()
        ...
        returns (bool)
    {
        return (!onlyAmbassadors  && msg.sender != _MummyAccount) ||
               (onlyAmbassadors && 
                (
                    (msg.sender == _MummyAccount && ambassadorsEthLedger_[_MummyAccount] < 2 ether) 
                    ||
